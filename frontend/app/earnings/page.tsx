          ...
          <div className={styles.summaryGrid}>
            <Card className={styles.balanceCard}>
              ...
              <div className={styles.balanceValue}>
                <span className="tabular-nums">₹12,400</span>
              </div>
            ...
            <Card className={styles.statsCard}>
              ...
              <div className={styles.breakdownRow}>
                ...
                <span className="tabular-nums">₹15,600</span>
              </div>
              <div className={styles.breakdownRow}>
                <span>Platform Commission (5%)</span>
                <span className={`${styles.dangerText} tabular-nums`}>- ₹780</span>
              </div>
              <div className={styles.totalRow}>
                <span>Net Payable</span>
                <span className={`${styles.accentText} tabular-nums`}>₹14,820</span>
              </div>
            </Card>
          </div>
        )}
              ...
              <tbody>
                {MOCK_PAYOUTS.map(p => (
                  <tr key={p.id}>
                    <td>{p.id}</td>
                    <td>{p.date}</td>
                    <td className={`${styles.textRight} tabular-nums`}>₹{p.amount}</td>
                    <td>
                      <StatusChip 
                        label={p.status} 
